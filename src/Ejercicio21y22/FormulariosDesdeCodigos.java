 ...
 * @author Osvaldo
 */
public class FormulariosDesdeCodigos extends javax.swing.JFrame {
    ...
    public FormulariosDesdeCodigos() {
        CreacionVentana();
        initComponents();
    }
    ...
    public void CreacionVentana(){
        ...
        etiNum1.setBounds(10,60,100,20);
        ...
        btnSumar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                btnSumarActionPerfomed(evt);
            }

            
        });
    }
    public void btnSumarActionPerfomed(ActionEvent evt) {
                double a,b,s;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormulariosDesdeCodigos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormulariosDesdeCodigos().setVisible(true);
            }
        });
    }
